        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "       <th style=\"text-align: center\" ng-repeat=\"col in colDefinitions\"><a ng-if=\"col.sortable\" ng-click=\"sortBy(col)\">{{col.displayName || col.field}}</a><span ng-if=\"!col.sortable\">{{col.displayName || col.field}}</span><i ng-if=\"col.sorted\" class=\"{{col.sortingIcon}} pull-right\"></i></th>\n" +
                    "     </tr>\n" +
                    "   </thead>\n" +
                    "   <tbody>\n" +
                    ...
                    "              <span ng-if=\"row.branch[expandingProperty.href]\" class=\"indented tree-label\"\n" +
                    "              style=\"cursor: pointer; color: {{row.branch[expandingProperty.color]}}\"\n" +
                    "              ng-click=\"on_user_click(row.branch)\" compile=\"expandingProperty.cellTemplate\"></span>\n" +
                    "              <span ng-if=\"!row.branch[expandingProperty.href]\" class=\"indented tree-label\"\n" +
                    "              style=\"cursor: auto; color: {{row.branch[expandingProperty.color]}}\"\n" +
                    "              compile=\"expandingProperty.cellTemplate\"></span>\n" +
                    // "              <span ng-if=\"expandingProperty.cellTemplate\" class=\"indented tree-label\" " +
                    // "              style=\"cursor: {{row.branch[expandingProperty.cursor]}}; color: {{row.branch[expandingProperty.color]}}\"\n" +
                    // "              ng-click=\"on_user_click(row.branch)\" compile=\"expandingProperty.cellTemplate\"></span>" +
                    // "              <span  ng-if=\"!expandingProperty.cellTemplate\" class=\"indented tree-label\" ng-click=\"on_user_click(row.branch)\">\n" +
                    // "             {{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}</span>\n" +
                    "       </td>\n" +
                    "       <td ng-repeat=\"col in colDefinitions\" style=\"text-align: center\">\n" +
